...
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"1_pg_outcome.png"),width=1000,height=600)
print(q)
dev.off()
...
q <- q + labs(title=sprintf("One harmonic for %s",yVar))
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"1_pg_residuals.png"),width=1000,height=600)
print(q)
dev.off()
...
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"2_pg_outcome.png"),width=1000,height=600)
print(q)
dev.off()
...
q <- q + scale_y_continuous("Residuals")
q <- q + labs(title=sprintf("Two harmonics for %s",yVar))
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"2_pg_residuals.png"),width=1000,height=600)
print(q)
dev.off()
...
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"3_pg_outcome.png"),width=1000,height=600)
print(q)
dev.off()
...
q <- q + scale_y_continuous("Residuals")
q <- q + labs(title=sprintf("Three harmonics for %s",yVar))
png(file.path(RAWmisc::PROJ$SHARED_TODAY,"3_pg_residuals.png"),width=1000,height=600)
print(q)
dev.off()
