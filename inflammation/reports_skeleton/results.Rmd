...
### Figure 1. Summary results of inflammation specific analyses for x- vs x+
![img](../../../results/res_x-_vs_x+.png)

## Tables

### Table 1. Demographic information
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/tableDemographics_2.RDS")
```

### Table 2. Associations between post-partum depression and summary pregnancy inflammation markers
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/LASSOmeanzscore_2_PG.RDS")
```

## Supplemental Material

### Figure S1. Inflammation markers in pregnant and post-partum women, coloured by post-partum depression status
![img](../../../results/boxplots_pregpp_by_case.png)

### Figure S2. QQ-plot of inflammation markers in pregnant women
![img](../../../results/qqplot_impg.png)

### Figure S3. QQ-plot of log2 inflammation markers in pregnant women
![img](../../../results/qqplotlog2_impg.png)

### Figure S4. Z-score of mean Z-scores of inflammation markers in pregnant women by serum vs plasma 
![img](../../../results/boxplots_serum_PG.png)

### Figure S5. Clustering of log2 PG IFs
![img](../../../results/log2impg_cluster.png)

### Table S1. Demographic information with more restrictive post-partum depression definition
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/tableDemographics_1.RDS")
```

### Table S2. Association between Z-score of mean Z-scores of pregnancy inflammation factors and demographic information
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/tableSimpleExposure_meanZPG.RDS")
```

### Table S3. Associations between post-partum depression and summary pregnancy inflammation markers in women with no history of earlier depression
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/LASSOmeanzscore_2_PG_earlierdep.RDS")
```

### Table S4. Associations between more a restrictive post-partum depression definition and summary pregnancy inflammation markers
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/LASSOmeanzscore_1_PG.RDS")
```

### Table S5. Associations between more a restrictive post-partum depression definition and summary pregnancy inflammation markers in women with no history of earlier depression
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/LASSOmeanzscore_1_PG_earlierdep.RDS")
```

### Table S6. Associations between x- vs x+ and individual inflammation factors
```{r, echo=FALSE, strip.white=FALSE}
readRDS("../../../results/IFsummariesTable.RDS")
```

# Other requested things not directly useable in this manuscript

### Figure X1. QQ-plot of inflammation markers in post-partum women
![img](../../../results/qqplot_impp.png)

### Figure X2. QQ-plot of log2 inflammation markers in post-partum women
![img](../../../results/qqplotlog2_impp.png)

### Figure X3. Z-score of mean Z-scores of inflammation markers in post-partum women by serum vs plasma
![img](../../../results/boxplots_serum_PP.png)
