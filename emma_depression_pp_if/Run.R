...
RAWmisc::InitialiseProject(
  ...
  RAW = "/analyses/data_raw/emma_depression_pp_if/",
  CLEAN = "/analyses/data_clean/emma_depression_pp_if",
  BAKED = "/analyses/results_baked/emma_depression_pp_if/",
  FINAL = "/analyses/results_final/emma_depression_pp_if/",
